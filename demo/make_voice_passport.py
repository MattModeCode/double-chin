...
Reads the voice's meta.json from MYNA_HOME (default ~/.myna); pass a
...
<div class="card">
  ...
  <dl>
    ...
    <dt>storage</dt><dd>this machine only: MYNA_HOME/voices/{name}/</dd>
  </dl>
  <div class="foot">
    <p>Deleting the voice folder revokes this voice entirely; no model weights remember it.</p>
    <p>Clone only a voice you have the right to clone. Issued {issued} by Myna.</p>
  </div>
</div>
</body></html>
"""
