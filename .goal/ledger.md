...
| G3 | Phase 1b — empirical Chatterbox MPS fine-tune smoke-train (the gate) | LEAD | IN PROGRESS | 0 | disqualifying gate: must produce a checkpoint on this Mac |
| G4 | Phase 2 — recording-script kit (≤60 min, phonetic+prosodic balance) + ingest/train pipeline | team | TODO | 0 | extend docs/recording-scripts.md |
| G5 | Phase 2 — THE HUMAN HAND-OFF: deliver scripts + import command | LEAD | TODO | 0 | the only pause |
...
HEARTBEAT: 2026-07-17T22:26:00Z Phase 1 done (Chatterbox chosen); starting G3 smoke-train + recording-kit hand-off.
