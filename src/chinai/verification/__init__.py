"""ChinAI indistinguishability verification suite.
...
extends the single-cosine check in `chinai.verify` (whose `similarity` /
...
from chinai.verification.gate import (
    GATE_PASS_THRESHOLD,
    GateResult,
    format_scorecard,
    gate_verdict,
...
from chinai.verification.naturalness import Naturalness, naturalness_proxy
from chinai.verification.prosody import (
    ProsodyFeatures,
    ProsodySimilarity,
    prosody_features,
    prosody_similarity,
)
from chinai.verification.speaker import SpeakerDiscrimination, speaker_discrimination
