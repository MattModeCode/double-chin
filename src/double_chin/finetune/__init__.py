...
def build_lora_config():
    ...
    Imported lazily so `import double_chin.finetune` stays cheap and free of a hard
...
def __getattr__(name):
    ...
    # import time) while still allowing `from double_chin.finetune import finetune_voice`.
    ...
    if name in ("build_examples", "split_examples", "resolve_audio", "TrainingExample"):
        from double_chin.finetune import dataset
